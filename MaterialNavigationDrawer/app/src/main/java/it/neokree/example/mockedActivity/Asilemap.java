...
public class Asilemap  extends  Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String StoreID = prefs.getString("storeID2","1");
        message = StoreID;
...
//        container.addView(routeButton);
        ...
        String StoreID2=prefs2.getString("storeID2","failed");
...
////		invalidateRestrooms();
		...
		sponsoredPinsOverlay = new SponsoredPinsOverlay(mapView) {
			...
			protected void onCalloutTap(final int index) {
				...
				Toast.makeText(Asilemap.this, message,
 ...
 //       router = mapView.getRouter();
        ...
        //startRouteCalculation();
        try {
            requestData(getResources().getString(R.string.localhost)+"rest3/v1/sponsoredproducts/" + message);
...
//		Section commonSection = getSection(21686229, 102976, 622867, "Health and Beauty Three");
//		sl.add(getProduct(1, "Test Product 1", new Section[] {
//		        commonSection
//		}));
//		sl.add(getProduct(4, "Test Product 4", new Section[] {
//		        commonSection
//		}));
//
//		sl.add(getProduct(2, "Test Product 2", new Section[] {
//		        getSection(21697724, 102977, 622880, "Frozen Ethnic")
//		}));
