...
public class ChangePhone extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.changeaphone);
    ...
    private void sendResult() {
        ...
        requestData(getResources().getString(R.string.localhost)+"rest3/v1/profilecontact",alpha);
