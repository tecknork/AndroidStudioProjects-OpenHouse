...
import it.neokree.example.mockedActivity.Asilemap2;
...
public class SearchProducts extends Activity {
    ...
    public SearchProducts CustomListView= null;
    private ArrayList<StoreProducts> movieList = new ArrayList<StoreProducts>();
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
     ...
     CustomListView=this;
        ...
        Intent msgIntent = new Intent(this, SearchProductUi.class);
...
//        }
    ...
    class CustomListAdapter extends BaseAdapter implements View.OnClickListener {
        ...
        private ArrayList<StoreProducts> data;
        private LayoutInflater inflater=null;
        public Resources res;
        StoreProducts tempValues=null;
        int i=0;
...
//        }
        ...
        public CustomListAdapter(Activity a, ArrayList<StoreProducts> d,Resources resLocal) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            else
            {
                ...
                tempValues=null;
                tempValues = ( StoreProducts ) data.get( position );

                /************  Set Model values in Holder elements ***********/
                if(tempValues!=null) {
                    holder.text.setText(tempValues.prodname);
                    holder.text1.setText(tempValues.prodname);
        ...
        private class OnItemClickListener  implements View.OnClickListener {
            ...
            public void onClick(View arg0) {
                ...
                StoreProducts product = (StoreProducts) a.getItem(mPosition);
                startActivity(new Intent(CustomListView, Asilemap2.class).putExtra("product", (Parcelable)product));
...
//            String  gender= intent.getStringExtra("gender");
            ...
            list= intent.getParcelableArrayListExtra("product7");
           // movieList=new ArrayList<Product>();

            movieList=list;

            Resources res =getResources();
            cardArrayAdapter = new CustomListAdapter(CustomListView, movieList,res);
